...
<head>
    ...
    <script src="{{ asset('assets/js/monetization.js') }}"></script>
...
<body>
    ...
    <div id="wrapper">
        ...
        <header class="header_area bg-img background-overlay-white"
            style="background-image: url(assets/img/bg-img/bg-1.jpg);">
                    ...
                    <div class="row h-100 align-items-center justify-content-end">
                        ...
                        <div class="col-12 col-lg-7">
                            <div class="top_single_area d-flex align-items-center">
                                <!-- Logo Area -->
                                <div class="top_logo">
                                    <a href="#"><img src="{{ asset('assets/img/core-img/logo.png') }}"
                                            alt=""></a>
                                </div>
                                <!-- Cart & Menu Area -->
                                        ...
                                        <ul class="cart-list">
                                            <li>
                                                <a href="#" class="image"><img
                                                        src="{{ asset('assets/img/product-img/product-10.jpg') }}"
                                            ...
                                            <li>
                                                <a href="#" class="image"><img
                                                        src="{{ asset('assets/img/product-img/product-11.jpg') }}"
                                                        class="cart-thumb" alt=""></a>
                                                <div class="cart-item-desc">
                                                    <h6><a href="#">Women's Fashion</a></h6>
                                                    <p>1x - <span class="price">$10</span></p>
